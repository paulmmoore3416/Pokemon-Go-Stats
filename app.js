...
const rawPokemonList = [
  ...
  // Additional 50 Pokemon
  { name: 'Mew', type: 'Psychic', stats: { HP: 225, Attack: 210, Defense: 210, Speed: 210, CP: 3500, IV: 95 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/151.png' },
  { name: 'Celebi', type: 'Psychic/Grass', stats: { HP: 225, Attack: 210, Defense: 210, Speed: 210, CP: 3500, IV: 95 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/251.png' },
  { name: 'Jirachi', type: 'Steel/Psychic', stats: { HP: 225, Attack: 210, Defense: 210, Speed: 210, CP: 3500, IV: 95 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/385.png' },
  { name: 'Deoxys', type: 'Psychic', stats: { HP: 137, Attack: 345, Defense: 115, Speed: 150, CP: 3500, IV: 96 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/386.png' },
  { name: 'Dialga', type: 'Steel/Dragon', stats: { HP: 205, Attack: 275, Defense: 211, Speed: 150, CP: 4500, IV: 98 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/483.png' },
  { name: 'Palkia', type: 'Water/Dragon', stats: { HP: 189, Attack: 280, Defense: 215, Speed: 150, CP: 4500, IV: 98 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/484.png' },
  { name: 'Giratina', type: 'Ghost/Dragon', stats: { HP: 284, Attack: 187, Defense: 225, Speed: 130, CP: 4500, IV: 98 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/487.png' },
  { name: 'Cresselia', type: 'Psychic', stats: { HP: 260, Attack: 152, Defense: 258, Speed: 130, CP: 3500, IV: 94 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/488.png' },
  { name: 'Darkrai', type: 'Dark', stats: { HP: 172, Attack: 285, Defense: 198, Speed: 180, CP: 4000, IV: 97 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/491.png' },
  { name: 'Shaymin', type: 'Grass', stats: { HP: 225, Attack: 210, Defense: 210, Speed: 210, CP: 3500, IV: 95 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/492.png' },
  { name: 'Arceus', type: 'Normal', stats: { HP: 237, Attack: 238, Defense: 238, Speed: 180, CP: 4500, IV: 99 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/493.png' },
  { name: 'Victini', type: 'Psychic/Fire', stats: { HP: 225, Attack: 210, Defense: 210, Speed: 210, CP: 3500, IV: 95 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/494.png' },
  { name: 'Snivy', type: 'Grass', stats: { HP: 128, Attack: 108, Defense: 130, Speed: 113, CP: 981, IV: 85 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/495.png' },
  { name: 'Tepig', type: 'Fire', stats: { HP: 163, Attack: 115, Defense: 85, Speed: 106, CP: 981, IV: 85 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/498.png' },
  { name: 'Oshawott', type: 'Water', stats: { HP: 146, Attack: 117, Defense: 85, Speed: 108, CP: 981, IV: 85 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/501.png' },
  { name: 'Chespin', type: 'Grass', stats: { HP: 148, Attack: 110, Defense: 106, Speed: 96, CP: 981, IV: 85 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/650.png' },
  { name: 'Fennekin', type: 'Fire', stats: { HP: 120, Attack: 116, Defense: 102, Speed: 129, CP: 981, IV: 85 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/653.png' },
  { name: 'Froakie', type: 'Water', stats: { HP: 121, Attack: 122, Defense: 84, Speed: 142, CP: 981, IV: 85 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/656.png' },
  { name: 'Rowlet', type: 'Grass/Flying', stats: { HP: 169, Attack: 107, Defense: 119, Speed: 101, CP: 981, IV: 85 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/722.png' },
  { name: 'Litten', type: 'Fire', stats: { HP: 128, Attack: 116, Defense: 112, Speed: 121, CP: 981, IV: 85 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/725.png' },
  { name: 'Popplio', type: 'Water', stats: { HP: 137, Attack: 120, Defense: 112, Speed: 114, CP: 981, IV: 85 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/728.png' },
  { name: 'Grookey', type: 'Grass', stats: { HP: 137, Attack: 122, Defense: 91, Speed: 128, CP: 981, IV: 85 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/810.png' },
  { name: 'Scorbunny', type: 'Fire', stats: { HP: 137, Attack: 130, Defense: 111, Speed: 120, CP: 981, IV: 85 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/813.png' },
  { name: 'Sobble', type: 'Water', stats: { HP: 137, Attack: 132, Defense: 79, Speed: 132, CP: 981, IV: 85 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/816.png' },
  { name: 'Sprigatito', type: 'Grass', stats: { HP: 120, Attack: 110, Defense: 101, Speed: 121, CP: 981, IV: 85 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/906.png' },
  { name: 'Fuecoco', type: 'Fire', stats: { HP: 167, Attack: 117, Defense: 91, Speed: 79, CP: 981, IV: 85 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/909.png' },
  { name: 'Quaxly', type: 'Water', stats: { HP: 146, Attack: 120, Defense: 88, Speed: 101, CP: 981, IV: 85 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/912.png' },
  { name: 'Koraidon', type: 'Fighting/Dragon', stats: { HP: 200, Attack: 285, Defense: 185, Speed: 200, CP: 4500, IV: 99 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/1007.png' },
  { name: 'Miraidon', type: 'Electric/Dragon', stats: { HP: 200, Attack: 285, Defense: 185, Speed: 200, CP: 4500, IV: 99 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/1008.png' },
  { name: 'Walking Wake', type: 'Water/Dragon', stats: { HP: 200, Attack: 280, Defense: 180, Speed: 190, CP: 4500, IV: 98 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/1009.png' },
  { name: 'Iron Leaves', type: 'Grass/Psychic', stats: { HP: 200, Attack: 280, Defense: 180, Speed: 190, CP: 4500, IV: 98 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/1010.png' },
  { name: 'Dipplin', type: 'Grass/Dragon', stats: { HP: 190, Attack: 170, Defense: 140, Speed: 120, CP: 2500, IV: 88 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/1011.png' },
  { name: 'Poltchageist', type: 'Grass/Ghost', stats: { HP: 120, Attack: 145, Defense: 110, Speed: 120, CP: 1500, IV: 85 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/1012.png' },
  { name: 'Sinistcha', type: 'Grass/Ghost', stats: { HP: 162, Attack: 178, Defense: 145, Speed: 150, CP: 2500, IV: 90 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/1013.png' },
  { name: 'Okidogi', type: 'Poison/Fighting', stats: { HP: 190, Attack: 240, Defense: 160, Speed: 140, CP: 3500, IV: 92 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/1014.png' },
  { name: 'Munkidori', type: 'Poison/Psychic', stats: { HP: 190, Attack: 240, Defense: 160, Speed: 140, CP: 3500, IV: 92 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/1015.png' },
  { name: 'Fezandipiti', type: 'Poison/Fairy', stats: { HP: 190, Attack: 240, Defense: 160, Speed: 140, CP: 3500, IV: 92 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/1016.png' },
  { name: 'Ogerpon', type: 'Grass', stats: { HP: 190, Attack: 240, Defense: 160, Speed: 140, CP: 3500, IV: 92 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/1017.png' },
  { name: 'Archaludon', type: 'Steel/Dragon', stats: { HP: 200, Attack: 250, Defense: 200, Speed: 120, CP: 4000, IV: 95 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/1018.png' },
  { name: 'Hydrapple', type: 'Grass/Dragon', stats: { HP: 212, Attack: 185, Defense: 180, Speed: 108, CP: 3500, IV: 91 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/1019.png' },
  { name: 'Gouging Fire', type: 'Fire/Dragon', stats: { HP: 205, Attack: 275, Defense: 211, Speed: 150, CP: 4500, IV: 98 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/1020.png' },
  { name: 'Raging Bolt', type: 'Electric/Dragon', stats: { HP: 189, Attack: 280, Defense: 215, Speed: 150, CP: 4500, IV: 98 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/1021.png' },
  { name: 'Iron Boulder', type: 'Rock/Psychic', stats: { HP: 200, Attack: 280, Defense: 180, Speed: 190, CP: 4500, IV: 98 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/1022.png' },
  { name: 'Iron Crown', type: 'Steel/Psychic', stats: { HP: 200, Attack: 280, Defense: 180, Speed: 190, CP: 4500, IV: 98 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/1023.png' },
  { name: 'Terapagos', type: 'Normal', stats: { HP: 200, Attack: 200, Defense: 200, Speed: 150, CP: 4000, IV: 96 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/1024.png' },
  { name: 'Pecharunt', type: 'Poison/Ghost', stats: { HP: 204, Attack: 190, Defense: 168, Speed: 170, CP: 3500, IV: 93 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/1025.png' },
  // Shiny Pokemon (25)
  { name: 'Shiny Pikachu', type: 'Electric', stats: { HP: 111, Attack: 112, Defense: 96, Speed: 110, CP: 938, IV: 87 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/025_f2.png' },
  { name: 'Shiny Charizard', type: 'Fire/Flying', stats: { HP: 156, Attack: 223, Defense: 173, Speed: 178, CP: 2889, IV: 93 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/006_f2.png' },
  { name: 'Shiny Bulbasaur', type: 'Grass/Poison', stats: { HP: 128, Attack: 118, Defense: 111, Speed: 90, CP: 981, IV: 85 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/001_f2.png' },
  { name: 'Shiny Squirtle', type: 'Water', stats: { HP: 127, Attack: 94, Defense: 121, Speed: 88, CP: 946, IV: 88 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/007_f2.png' },
  { name: 'Shiny Gengar', type: 'Ghost/Poison', stats: { HP: 155, Attack: 261, Defense: 149, Speed: 180, CP: 2878, IV: 91 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/094_f2.png' },
  { name: 'Shiny Dragonite', type: 'Dragon/Flying', stats: { HP: 209, Attack: 263, Defense: 198, Speed: 180, CP: 3792, IV: 97 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/149_f2.png' },
  { name: 'Shiny Lucario', type: 'Fighting/Steel', stats: { HP: 172, Attack: 236, Defense: 144, Speed: 170, CP: 2703, IV: 92 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/448_f2.png' },
  { name: 'Shiny Snorlax', type: 'Normal', stats: { HP: 330, Attack: 190, Defense: 169, Speed: 90, CP: 3225, IV: 89 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/143_f2.png' },
  { name: 'Shiny Mewtwo', type: 'Psychic', stats: { HP: 214, Attack: 300, Defense: 182, Speed: 200, CP: 4178, IV: 98 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/150_f2.png' },
  { name: 'Shiny Eevee', type: 'Normal', stats: { HP: 146, Attack: 104, Defense: 114, Speed: 100, CP: 1071, IV: 86 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/133_f2.png' },
  { name: 'Shiny Garchomp', type: 'Dragon/Ground', stats: { HP: 239, Attack: 261, Defense: 193, Speed: 180, CP: 3962, IV: 95 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/445_f2.png' },
  { name: 'Shiny Greninja', type: 'Water/Dark', stats: { HP: 145, Attack: 223, Defense: 152, Speed: 180, CP: 2654, IV: 90 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/658_f2.png' },
  { name: 'Shiny Machamp', type: 'Fighting', stats: { HP: 207, Attack: 234, Defense: 159, Speed: 130, CP: 3056, IV: 90 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/068_f2.png' },
  { name: 'Shiny Alakazam', type: 'Psychic', stats: { HP: 146, Attack: 271, Defense: 167, Speed: 180, CP: 3057, IV: 92 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/065_f2.png' },
  { name: 'Shiny Blastoise', type: 'Water', stats: { HP: 188, Attack: 171, Defense: 207, Speed: 120, CP: 2466, IV: 89 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/009_f2.png' },
  { name: 'Shiny Venusaur', type: 'Grass/Poison', stats: { HP: 190, Attack: 198, Defense: 189, Speed: 120, CP: 2720, IV: 91 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/003_f2.png' },
  { name: 'Shiny Arcanine', type: 'Fire', stats: { HP: 207, Attack: 227, Defense: 166, Speed: 180, CP: 2839, IV: 90 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/059_f2.png' },
  { name: 'Shiny Lapras', type: 'Water/Ice', stats: { HP: 277, Attack: 165, Defense: 174, Speed: 130, CP: 2641, IV: 88 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/131_f2.png' },
  { name: 'Shiny Jolteon', type: 'Electric', stats: { HP: 163, Attack: 232, Defense: 182, Speed: 200, CP: 2888, IV: 87 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/135_f2.png' },
  { name: 'Shiny Vaporeon', type: 'Water', stats: { HP: 277, Attack: 205, Defense: 161, Speed: 130, CP: 3114, IV: 90 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/134_f2.png' },
  { name: 'Shiny Flareon', type: 'Fire', stats: { HP: 163, Attack: 246, Defense: 179, Speed: 180, CP: 3029, IV: 88 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/136_f2.png' },
  { name: 'Shiny Umbreon', type: 'Dark', stats: { HP: 216, Attack: 126, Defense: 240, Speed: 120, CP: 2137, IV: 91 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/197_f2.png' },
  { name: 'Shiny Espeon', type: 'Psychic', stats: { HP: 163, Attack: 261, Defense: 175, Speed: 180, CP: 3170, IV: 92 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/196_f2.png' },
  { name: 'Shiny Sylveon', type: 'Fairy', stats: { HP: 216, Attack: 203, Defense: 205, Speed: 120, CP: 3069, IV: 90 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/700_f2.png' },
  { name: 'Shiny Metagross', type: 'Steel/Psychic', stats: { HP: 190, Attack: 257, Defense: 228, Speed: 130, CP: 3791, IV: 95 }, image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/376_f2.png' }
];
